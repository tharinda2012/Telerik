        ...
        public void TestMethod_Create_MailBox()
        {
            ...
            try
            {
               ...
               Thread.Sleep(config.Default.SleepingTime * 3); 
                ...
                con.Execute_SQLQuery("select address,category_id,priority from MAIL_IN_FILTER where address = '" + fulladdress + "' ");
                ...
                con2.Execute_SQLQuery("select title, author from ticket where title= '" + title + "'");
                var counter = 0;
                ...
                con3.Execute_SQLQuery("delete MAIL_IN_FILTER where address = '" + fulladdress + "'");                
